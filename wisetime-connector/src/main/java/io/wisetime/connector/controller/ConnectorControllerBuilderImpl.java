...
public class ConnectorControllerBuilderImpl implements ConnectorController.Builder,
  ...
  private int tagSyncIntervalMinutes = DEFAULT_TAG_SYNC_INTERVAL_MINUTES;
  private int tagSyncSlowLoopIntervalMinutes = DEFAULT_TAG_SYNC_SLOW_LOOP_INTERVAL_MINUTES;
  private int activityTypeSyncIntervalMinutes = DEFAULT_ACTIVITY_TYPE_SYNC_INTERVAL_MINUTES;
  private int activityTypeSyncSlowLoopIntervalMinutes = DEFAULT_ACTIVITY_TYPE_SYNC_SLOW_LOOP_INTERVAL_MINUTES;
  ...
  @Override
  public ConnectorController.Builder withTagSyncIntervalMinutes(int minutes) {
    this.tagSyncIntervalMinutes = minutes;
    return this;
  }

  @Override
  public ConnectorController.Builder withTagSyncSlowLoopIntervalMinutes(int minutes) {
    this.tagSyncSlowLoopIntervalMinutes = minutes;
    return this;
  }

  @Override
  public ConnectorController.Builder withActivityTypeSyncIntervalMinutes(int minutes) {
    this.activityTypeSyncIntervalMinutes = minutes;
    return this;
  }

  @Override
  public ConnectorController.Builder withActivityTypeSyncSlowLoopIntervalMinutes(int minutes) {
    this.activityTypeSyncSlowLoopIntervalMinutes = minutes;
    return this;
  }
  ...
  public int getFetchClientLimit() {
    return RuntimeConfig.getInt(ConnectorConfigKey.LONG_POLL_BATCH_SIZE)
        .orElse(fetchClientFetchLimit);
  }

  @Override
  public int getTagSyncIntervalMinutes() {
    return RuntimeConfig.getInt(ConnectorConfigKey.TAG_SYNC_INTERVAL_MIN)
        .orElse(tagSyncIntervalMinutes);
  }

  @Override
  public int getTagSyncSlowLoopIntervalMinutes() {
    return RuntimeConfig.getInt(ConnectorConfigKey.TAG_SYNC_SLOW_LOOP_INTERVAL_MIN)
        .orElse(tagSyncSlowLoopIntervalMinutes);
  }

  @Override
  public int getActivityTypeSyncIntervalMinutes() {
    return RuntimeConfig.getInt(ConnectorConfigKey.ACTIVITY_TYPE_SYNC_INTERVAL_MIN)
        .orElse(activityTypeSyncIntervalMinutes);
  }

  @Override
  public int getActivityTypeSyncSlowLoopIntervalMinutes() {
    return RuntimeConfig.getInt(ConnectorConfigKey.ACTIVITY_TYPE_SYNC_SLOW_LOOP_INTERVAL_MIN)
        .orElse(activityTypeSyncSlowLoopIntervalMinutes);
  }
