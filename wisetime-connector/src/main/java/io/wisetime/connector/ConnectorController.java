...
public interface ConnectorController {
  ...
  interface Builder {
    ...
    /**
     * Set connector interval to sync tags.
     */
    Builder withTagSyncIntervalMinutes(int minutes);

    /**
     * Set connector slow loop interval to sync tags.
     */
    Builder withTagSyncSlowLoopIntervalMinutes(int minutes);

    /**
     * Set connector interval to sync activity types.
     */
    Builder withActivityTypeSyncIntervalMinutes(int minutes);

    /**
     * Set connector slow loop interval to sync activity types.
     */
    Builder withActivityTypeSyncSlowLoopIntervalMinutes(int minutes);
