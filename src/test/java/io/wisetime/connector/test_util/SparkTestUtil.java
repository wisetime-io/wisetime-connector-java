...
public class SparkTestUtil {
  ...
  /**
   * Convenience method to use own truststore on SSL Sockets. Will default to the self signed keystore provided in
   * resources,
   * but will respect
   * <p/>
   * -Djavax.net.ssl.keyStore=serverKeys -Djavax.net.ssl.keyStorePassword=password -Djavax.net.ssl.trustStore=serverTrust
   * -Djavax.net.ssl.trustStorePassword=password SSLApplication
   * <p/>
   * So these can be used to specify other key/trust stores if required.
   *
   * @return an SSL Socket Factory using either provided keystore OR the keystore specified in JVM params
   */
  ...
  /**
   * Return JVM param set truststore location, or keystore location if not set. if keystore not set either, returns default
   *
  ...
  /**
   * Return JVM param set truststore password or keystore password if not set. If still not set, will return default
   * password
   *
